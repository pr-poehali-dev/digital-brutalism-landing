    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="space-y-8">
          <h1 className="text-5xl md:text-7xl leading-tight max-w-4xl">
            Эту страницу я сделал по одной причине —
          </h1>
          <p className="text-3xl md:text-5xl leading-tight max-w-4xl">
            чтобы мы не тратили время друг друга впустую.
          </p>
        </div>
        
        <div className="mt-16 space-y-6 max-w-3xl font-mono text-base leading-relaxed">
          <p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        <div className="border border-black p-8 bg-[#F5F5F5]">
          ...
          <h2 className="text-3xl mb-2">MARKETING SPECIALIST</h2>
          <div className="font-mono text-sm space-y-1">
            <p>PROFILE OVERVIEW</p>
            <p>VERSION 2025.11</p>
            <p className="text-muted-foreground">(no noise, no legends)</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* Scenario 1 */}
          <div className="border border-black p-8 bg-white hover:bg-[#F5F5F5] transition-colors">
        ...
        <div className="mt-12 border-l-4 border-black pl-8 max-w-3xl">
          <p className="font-mono text-xl leading-relaxed mb-4">
            Честно?
          </p>
          <p className="font-mono text-lg leading-relaxed">
            Иногда рынок выглядит как хаотичный кастинг.
          </p>
          <p className="font-mono text-lg leading-relaxed mt-4">
            И разбираться во всём этом приходится тебе.<br />
            А потом ещё объяснять бизнесу, почему «вроде нормальный» не сработал.
          </p>
          <p className="font-mono text-lg leading-relaxed mt-6 font-bold">
      ...
      {/* Why Me */}
      <section className="max-w-6xl mx-auto px-6 py-20 bg-[#F5F5F5] -mx-6">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl md:text-5xl mb-12">
            Почему со мной обычно спокойно
          </h2>
          <p className="font-mono text-lg mb-12 max-w-3xl">
            Я не идеален.<br />
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={item.num} className="border border-black p-6 bg-white">
                <div className="font-mono text-4xl mb-4 text-[#FF4D00]">
                  {item.num}
                </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="border-l-4 border-[#FF4D00] pl-8 mb-12">
          <p className="text-3xl">
            Это про деньги, а не про украшения
          </p>
        </div>

        <div className="space-y-8 font-mono text-lg max-w-3xl">
          <div className="border-b border-black pb-6">
            <p className="font-bold mb-2">Красивое — вторично. Рабочее — первично.</p>
          </div>
          <div className="border-b border-black pb-6">
            <p className="font-bold mb-2">Сначала продукт, потом упаковка</p>
            <p className="text-sm text-muted-foreground">Без смысла креатив не спасает.</p>
          </div>
          <div className="border-b border-black pb-6">
            <p className="font-bold mb-2">Решения — через цифры</p>
            <p className="text-sm text-muted-foreground">Идея → проверка → вывод. Никакой магии.</p>
          </div>
          <div className="pb-6">
            <p className="font-bold mb-2">Я понимаю бизнес-контекст</p>
            <p className="text-sm">
              Я знаю, что такое:<br />
              — расходы<br />
              — маржинальность<br />
        ...
        <div className="mt-12 border border-black p-8 bg-[#F5F5F5] max-w-3xl">
          <p className="text-xl">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="border-2 border-black p-12 text-center">
          ...
          <Button 
            className="bg-[#FF4D00] hover:bg-[#E04500] text-white px-12 py-6 text-lg font-mono uppercase tracking-wider border-none rounded-none"
          >
            START SCAN
          </Button>
        </div>
      ...
      {/* Final Section */}
      <section className="max-w-6xl mx-auto px-6 py-20 bg-black text-white -mx-6">
        <div className="max-w-6xl mx-auto px-6">
          <p className="font-mono text-lg mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="font-mono mt-6 text-sm text-gray-400">
            ...
            <div>
              ...
              <p className="font-mono mt-6 text-2xl">👇 Тогда просто напиши.</p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            >
              <Button 
                className="bg-[#FF4D00] hover:bg-[#E04500] text-white px-16 py-8 text-xl font-mono uppercase tracking-wider border-none rounded-none"
              >
                Связаться
              </Button>
            </a>
      ...
      {/* Footer */}
      <footer className="border-t border-black py-6 px-6 bg-white">
        <div className="max-w-6xl mx-auto font-mono text-xs text-center text-muted-foreground">
